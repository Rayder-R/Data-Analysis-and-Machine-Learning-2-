...
(train_feature, train_label), (test_feature,
                               test_label) = keras.datasets.mnist.load_data()
...
# 查看轉換後的形狀
print("轉換後訓練資料形狀:", train_feature_vector.shape)  # (60000, 28, 28, 1)
...
# 確認標準化後的數值範圍
print("標準化後的最小值:", train_feature_normalize.min(), "最大值:", train_feature_normalize.max())
